...
public class UpdateArticle extends javax.swing.JFrame {
    ...
    private final ArrayList<Integer> ids_registereds;
    private int[] indices;
    ...
    public UpdateArticle(Article a) {
        ...
        try {      
            ...
            ResultSet rs = Registered.findByEventAndEdition(MainFrame.db, this.article.getCodEv(), this.article.getNumEd(), true);
            while(rs.next()) {
            ...
            this.jComboBox3.setSelectedIndex(this.ids_registereds.indexOf(this.article.getIdApr()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(tituloArt.isEmpty() || presenterName == null) {
        ...
        try {
            ...
            if (dataApresArt != null) {
                Edition ed = Edition.findByPrimaryKey(MainFrame.db, this.article.getCodEv(), this.article.getNumEd());
                // fecha o cursor
                MainFrame.db.close();
            ...
            Registered r = Registered.findByPrimaryKey(MainFrame.db, this.article.getCodEv(), this.article.getNumEd(), idApr);
